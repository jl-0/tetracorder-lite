        ...
        */
        if (V_TYPE(left) == ID_DEREF) {
            ...
            if (p2 && V_TYPE(p2) == ID_FUNCTION) {
                ...
                parse_error
                    ("Function dereference allowed for module variables only.");
                push(scope, NULL);
            }
	...
	case ID_MULSET:
        ...
        */
        if (V_TYPE(left) == ID_ARRAY) {
            ...
            if (type == ID_DIVSET) p5 = pp_math(p3, ID_DIV, p2);
            if (type == ID_MULSET) p5 = pp_math(p3, ID_MULT, p2);
            ...
            */
            ...
            if (type == ID_DIVSET) p5 = pp_math(p4, ID_DIV, p3);
            if (type == ID_MULSET) p5 = pp_math(p4, ID_MULT, p3);
            ...
            if (type == ID_DIVSET) p5 = pp_math(p1, ID_DIV, p2);
            if (type == ID_MULSET) p5 = pp_math(p1, ID_MULT, p2);
        ...
        */
        ...
        if (p1 == NULL || p2 == NULL) {
            ...
            push(scope, NULL);
                  ...
                  search_in_list_of_loaded_modules(V_NAME(p1))) != NULL) {
            vfuncptr t;
