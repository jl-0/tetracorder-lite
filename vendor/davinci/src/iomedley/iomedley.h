...
int iom_GetPNMHeader(FILE *fp, char *fnmae, struct iom_iheader *h);
int iom_GetJPEGHeader(FILE *fp, char *fnmae, struct iom_iheader *h);
int iom_GetPNGHeader(FILE *fp, char *fnmae, struct iom_iheader *h);
int iom_GetTIFFHeader(FILE *fp, char *fnmae, struct iom_iheader *h);
int iom_GetGIFHeader(FILE *fp, char *fnmae, struct iom_iheader *h);
...
size_t iom_Cpos(int x, int y, int z, int org, const int size[3]);
void iom_Xpos(size_t i, int org, const int size[3], int *x, int *y, int *z);
