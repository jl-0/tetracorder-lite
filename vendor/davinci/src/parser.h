...
#define V_LONG(v)	(*((long *)V_DATA(v)))	/* derefernce as a single long int (64-bit) */
...
#define NBYTES(a)	(((a) == INT || (a) == UINT) ? 4 : ((a) == USHORT ? 2 : ((a) == LONG  ? 8 : ((a) == VAX_FLOAT ? 4 : ((a) == VAX_INTEGER ? 2 : (a))))))
...
#define saturate_long(v)		saturate(v,(MINLONG), (MAXLONG))
