char *version = "@(#) daVinci Version #3.02";

#include "build.h"

/*
  Version 3.02: Wed May 28 14:33:20 MST 2025
  * Minor fixes for succussful build on MacOS.
  * Also made changes to davinci_build.

  Version 3.01: Wed Feb 26 13:17:44 MST 2025
  * Added handling of LONG data type in pack/unpack, RAW and HDF I/O
  * Bug fix in pack when output length is shorter than the input string
  
  Version 3.00: Fri Dec 27 08:54:38 MST 2024
  * Added support for LONG ints.
  * Injected LONG int data type in basic operations
  * Fixes to ISIS3 native reader/writer
  * Fixes related to unsigned integers
  * Fixes in FITS reader to prevent infinite loop reading SuperCam data

  Version 2.30: Tue Feb 21 15:24:35 MST 2023
  * FITS reader now supports LONGLONG_IMG (64-bit integer)
    data type as doubles.
  * HDF5 reader now supports text arrays stored as arrays
    instead of as a single text string separated by CRs.

  Version 2.29: Mon Nov  7 12:40:56 MST 2022
  * FITS reader now supports TDIM keyword
  * FITS reader now handles unsigned data
  * HDF reader now supports reading 64-bit integers as doubles
  * Initial version of recoded ISIS3 reader checked in
  * Refactored some code and added some utility function
